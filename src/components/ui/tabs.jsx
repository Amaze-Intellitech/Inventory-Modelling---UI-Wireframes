...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-sm bg-bg p-1 text-body-c border border-border',
      className
    )}
    {...props}
  />
